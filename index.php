                    ...
                    <form name='LoginForm' action='login.php' method='POST'>
                         <table cellpadding="0" cellspacing="0" border='0' width='100%'>
                            <tr>
                                ...
                                <td align="left" class="w_padding">
                                    <input type='text' name='userid' value='' maxlength='25' style='width: 110px;'>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" class="w_padding">
                                ...
                                <td align="left" class="w_padding">
                                    <input type='password' name='password' value='' maxlength='25' style='width: 110px;'>
                                </td>
                            </tr>
                            <tr>
...
<tr><td colspan="2" align="center"><font size="6" color="ff0000">Buy This Multi-Phase Company Forced Matrix with Spillover/Spillunder v.10.1 Script Now For Only $299.99!</font></td></tr>
</table>
