...
--
-- Host: localhost    Database: phpsites_demomatrixmpcf
-- ------------------------------------------------------
...
CREATE TABLE `matrix1` (
  ...
  `L2` int(10) unsigned NOT NULL,
  `L3` int(10) unsigned NOT NULL,
  `L4` int(10) unsigned NOT NULL,
  `parent1` int(10) unsigned NOT NULL,
  `parent1username` varchar(255) NOT NULL,
  `parent2` int(10) unsigned NOT NULL,
  `parent2username` varchar(255) NOT NULL,
  `parent3` int(10) unsigned NOT NULL,
  `parent3username` varchar(255) NOT NULL,
  `parent4` int(10) unsigned NOT NULL,
  `parent4username` varchar(255) NOT NULL,
  `datecycled` datetime NOT NULL,
  `cycled` varchar(4) NOT NULL DEFAULT 'no',
  `urlreferrerid` int(10) unsigned NOT NULL,
  ...
  `positionordernumber` int(10) unsigned NOT NULL,
...
INSERT INTO `matrix1` (`id`, `username`, `L1`, `L2`, `L3`, `L4`, `parent1`, `parent1username`, `parent2`, `parent2username`, `parent3`, `parent3username`, `parent4`, `parent4username`, `datecycled`, `cycled`, `urlreferrerid`, `urlreferrername`, `owed`, `paid`, `lastpaid`, `paychoice`, `transaction`, `positionordernumber`, `signupdate`) VALUES (1,'COMPANY',0,0,0,0,0,'',0,'',0,'',0,'','0000-00-00 00:00:00','no',1,'COMPANY',0.00,0.00,'0000-00-00 00:00:00','Admin','Admin',1,'2015-01-26 05:48:11');
...
INSERT INTO `matrix2` (`id`, `username`, `L1`, `L2`, `L3`, `L4`, `parent1`, `parent1username`, `parent2`, `parent2username`, `parent3`, `parent3username`, `parent4`, `parent4username`, `datecycled`, `cycled`, `urlreferrerid`, `urlreferrername`, `owed`, `paid`, `lastpaid`, `paychoice`, `transaction`, `positionordernumber`, `signupdate`) VALUES (1,'COMPANY',0,0,0,0,0,'',0,'',0,'',0,'','0000-00-00 00:00:00','no',1,'COMPANY',0.00,0.00,'0000-00-00 00:00:00','Admin','Admin',1,'2015-01-26 05:53:40');
/*!40000 ALTER TABLE `matrix2` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `matrixconfiguration`
--

DROP TABLE IF EXISTS `matrixconfiguration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `matrixconfiguration`
--

LOCK TABLES `matrixconfiguration` WRITE;
/*!40000 ALTER TABLE `matrixconfiguration` DISABLE KEYS */;
INSERT INTO `matrixconfiguration` (`id`, `matrixlevelname`, `matrixwidth`, `matrixdepth`, `matrixprice`, `matrixpayout`, `givereentrythislevel`, `matrixactive`, `matrixsequence`, `cyclecommissionforsponsor`) VALUES (1,'phase 1',1,4,2.00,2.00,'yes','yes',1,1.00),(2,'phase 2',1,4,4.00,4.00,'yes','no',2,1.00);
/*!40000 ALTER TABLE `matrixconfiguration` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `subscriptions` (`id`, `userid`, `transaction`, `paymentdate`, `amountreceived`) VALUES (1,'demomember','1','2015-01-26',35.00);
...
INSERT INTO `transactions` (`id`, `userid`, `action`, `date`, `quantity`) VALUES (1,'demomember','TEST 1 - 1 Matrix Phase: Test Phase 1 Position',1411267662,'');
...
--
-- Dumping events for database 'phpsites_demomatrixmpcf'
--

--
-- Dumping routines for database 'phpsites_demomatrixmpcf'
--
...
-- Dump completed on 2015-04-30  9:49:16
