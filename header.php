<html>
<head>
<title>Multi-Phase Company Forced Matrix with Spillover/Spillunder v.10.1 Demo</title>
         ...
         <td>
          <table cellpadding="0" cellspacing="0" border="0" width="958">
             <tr align="center" style='height: 40px;'>
					...
					<td class='divider'></td>
<td class='left_inactive'></td><td class='center_inactive'><a href='<?php echo $domain ?>/comparememberships.php?referid=<?php echo $referid ?>' class='menu'>Compare</a></td><td class='right_inactive'></td>
<td class='divider'></td>
